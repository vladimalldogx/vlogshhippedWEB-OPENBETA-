...
<head>
    ...
    <title>Account Report-Vlogshipped</title>
...
<body class="nav-md" ng-app="myApp">
					...
					<div id="sidebar-menu" class=" main_menu_side hidden-print main_menu" style="color:aliceblue;">
						<div class="menu_section">
							...
							<li class="dropdown">
							  ...
							  <li> <a href="students.php"><i class="fa fa-user"></i> Accounts Management </a> </li>
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h1>User Account Reports</h1>
                                <ul class="nav navbar-right panel_toolbox">
                                    <li><a href="#" ng-click="deleteStudent(s.stud_id)" class="btn btn-primary btn-xs"><i class="fa fa-print"></i> Print All </a> </td> </li>
                                </ul>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                    ...
                                    <tbody>
                                        ...
                                        <tr ng-repeat="s in students |  filter:search">
                                            ...
                                            <td>
                                                ...
                                                <a href="#" ng-click="deleteStudent(s.stud_id)" class="btn btn-primary btn-xs"><i class="fa fa-print"></i> Print </a> </td>                                        </tr>
                                        <!-- END MODAL -->
                                    </tbody>
                                </table>
                                <!-- end project list -->
    ...
    <script>
        ...
        app.controller("myCtrl", function($http, $scope) {
            $http.get('../controller/studentController/allWilla.php').then(function(response) {
                $scope.student_label = ["report id", "user_id","Lastname", "Firstname", "User Type", "email", "password", "date created",  "ACTION"];
