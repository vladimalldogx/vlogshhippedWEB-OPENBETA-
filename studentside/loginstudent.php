<?php
	...
	if(isset($_SESSION[""]))
	{
		header("location: studentside/studindex.php");
		exit;
	}
	...
	if(isset($_GET["login-username"]))
	{
		...
		if(count($exist_user) > 0)
		{
			...
			$_SESSION["stud_id"] = $username;
			$_SESSION["stud_id"] = $exist_user["stud_id"];
...
<body id="page-top" ng-app="myApp" ng-controller="myCtrl">
	...
	<br>
	<br><br><br/>
    <form method = "GET" action = "loginstudent.php">
		...
		<div class = "input-group">
			<input type = "text" required = "required" vaue = "<?php  echo $username; ?>" autofocus="true" tabindex="1" placeholder = "pls input your id number first as username" name = "username">
			...
			<p>admin or working student? <a href="../adminlog/adminlog.php"> Click here</a></p>
		</br>
	</br>
	</br>
	</br>
