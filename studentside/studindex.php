...
<head>
	...
	<link rel="icon" type="../view/image/png" href="../view/image/lock.png">
	<!-- Bootstrap core CSS -->
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
                    ...
                    <?php 
                     echo " <li class='nav-item'> <a class='nav-link js-scroll-trigger' href='dashboard.php'> Hi {$fname}!</a> </li>";

                        ?> 

					<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#loginModal"><a href="../index.php">Log-out</a></button>
				</ul>
			</div>
		</div>
	</nav>
			...
			<div class="row">
				<div class="col-lg-8 mx-auto">
					...
					<p class="lead">
						...
						<br/>
						<p>For more Info in regarding in your Department pls go to Department
						<br>
						<button class=" btn btn-primary" "w3-yellow" type="button" ><a href="departments.php">See Department</a> </button>
					</p>
				</div>
			</div>
		</div>
